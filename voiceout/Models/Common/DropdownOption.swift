...
extension DropdownOption {
    ...
    static let timezones: [DropdownOption] = [
        DropdownOption(option: "Chicago (GMT-5)"),
        DropdownOption(option: "Denver (GMT-6)"),
        DropdownOption(option: "Phoenix (GMT-7)"),
        DropdownOption(option: "Los Angeles (GMT-7)"),
