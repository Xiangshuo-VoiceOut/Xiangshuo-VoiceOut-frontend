                        ...
                        VStack {
                            ...
                            ZStack {
                                TextInputView(
                                    ...
                                    prefixIcon: "protect",
                                    validationState: forgetPasswordVM.isVarificationCodeValid ? ValidationState.neutral : ValidationState.error
                                )
                            ...
                            ButtonView(text: "next_step", action: {}, theme: forgetPasswordVM.isNextButtonEnabled ? .action : .base).disabled(!forgetPasswordVM.isNextButtonEnabled)
