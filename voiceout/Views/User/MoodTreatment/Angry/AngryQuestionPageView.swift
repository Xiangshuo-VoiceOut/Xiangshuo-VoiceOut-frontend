...
struct AngryQuestionPageView: View {
    ...
    var body: some View {
        ZStack {
            ...
            ZStack(alignment: .top) {
                ...
                if question?.uiStyle == .styleAngryTiming, timingStepIndex == 0 {
            ...
            if question?.uiStyle == .styleAngryTiming {
                VStack(spacing: 0) {
                    ...
                    AngryQuestionStyleTimingView(stepIndex: $timingStepIndex)
    ...
    private var contentBody: some View {
        if let q = question {
            switch q.uiStyle {
            case .styleA:
                AngryQuestionStyleAView(question: q, onSelect: handleSelect)
            case .styleB:
                AngryQuestionStyleBView(question: q, onSelect: handleSelect)
            case .styleC:
            ...
            case .styleG:
                AngryQuestionStyleGView(question: q, onSelect: handleSelect)
            case .styleBottle:
                AngryQuestionStyleBottleView(messages: q.introTexts ?? [])
            case .styleNote:
                AngryQuestionStyleNoteView(question: q)
