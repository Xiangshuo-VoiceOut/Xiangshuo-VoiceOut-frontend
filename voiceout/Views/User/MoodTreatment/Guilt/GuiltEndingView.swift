//
//  GuiltEndingView.swift
//  voiceout
//
//  Created by Yujia Yang on 2/13/26.
//

import SwiftUI

struct GuiltEndingView: View {
    ...
    var body: some View {
        let bubbleInsets = EdgeInsets(top: 2*ViewSpacing.betweenSmallAndBase, leading: 2*ViewSpacing.betweenSmallAndBase, bottom: 2*ViewSpacing.betweenSmallAndBase, trailing: 2*ViewSpacing.betweenSmallAndBase)
        ...
        ZStack(alignment: .topLeading) {
            ...
            GeometryReader { geo in
                let canvasW: CGFloat = 388
                let canvasH: CGFloat = 485
                let scale = geo.size.width / canvasW
                let scaledH = canvasH * scale
                let basketBottomY: CGFloat = canvasH * scale
                let offsetY = geo.size.height - basketBottomY

                LottieView(
                    animationName: "guilt-end",
                    loopMode: .loop,
                    autoPlay: true,
            ...
            HStack(alignment: .top, spacing: ViewSpacing.small) {
                ...
                Image("cloud-chat")
                    ...
                    .offset(x: 2*ViewSpacing.betweenSmallAndBase)
            }
...
#Preview {
    ...
    let randomEnding = guiltEndings.randomElement()!

    GuiltEndingView(
        question: MoodTreatmentQuestion(
            id: 999,
            totalQuestions: 45,
            uiStyle: .guiltStyleEnding,
            texts: [randomEnding],
            animation: nil,
            options: [],
            introTexts: nil,
