        ...
        return MoodPageContainerView(
            ...
            content: {
                VStack(spacing: 0) {
                    ...
                    .padding(.top, ViewSpacing.large*ViewSpacing.betweenSmallAndBase)
            ...
            background: {
                ZStack {
                    Image("light")
                        ...
                        .offset(x: 3*ViewSpacing.betweenSmallAndBase,y: LogoSize.large)
                        .allowsHitTesting(false)
                    Image("scare")
                        .resizable()
                        .scaledToFit()
                        .frame(height: 125)
                        .offset(y: LogoSize.large+ViewSpacing.medium+ViewSpacing.large)
                        .allowsHitTesting(false)
                }
